...
def dbinit():
	...
	# Lista di 15 tuple (titolo, trama, anno, url_locandina, tmdb_id)
        film_esempi = [
            ...
            ("Forrest Gump", "Le presidenze di Kennedy e Johnson, gli eventi del Vietnam, del Watergate e altre vicende storiche si snodano attraverso la prospettiva di un uomo dell'Alabama con un basso quoziente intellettivo.", 1994, "https://www.themoviedb.org/t/p/w60₀_and_h9₀₀_face/gsbmOBQKIzO3q57pITk9Ol4urV2.jpg", "13"),
